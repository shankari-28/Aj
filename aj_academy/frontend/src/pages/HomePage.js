    ...
    <div className="min-h-screen bg-white">
      ...
      <footer className="bg-gray-900 text-white py-12">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-500">
          ...
          <a href="https://www.digitekera.com/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center mt-3 gap-2 no-underline hover:opacity-80">
            <img src="/assets/digitek_log.png" alt="DigiTekEra Logo" style={{ width: 20, height: 20 }} />
            <span className="text-gray-400">Powered by DigiTekEra</span>
          </a>
        </div>
